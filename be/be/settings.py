"""
Django settings for the SMS fraud detector backend.
...
# Default values support local development; override them in production.

# Keep the production secret key out of source control.
